...
const routes = [
  { path: '/login', component: () => import('@/views/Login.vue'), meta: { guest: true } },
  {
    ...
    children: [
      ...
      // 旧链接兼容: 重定向到带 tab query 的新路由, 历史链接不失效
      { path: 'course-instances', redirect: '/course?tab=instances' },
      { path: 'course-enrollments', redirect: '/course?tab=enrollments' },
      ...
      // 内容 - 科普文章 (2026-07-03 MM=36): 平台超管发, C 端展示
