...
// R-4103 GET /admin/cron/ticks — 流水查询
// 注意: 必须放在 /:name/tick 之前, 否则 :name 会吞掉 'ticks'
// 查 cron_tick_logs 集合, 默认按 startedAt 倒序; 支持 name/ok/source/pid/from/to 过滤
// 仅平台超管 (ops 数据)
router.get('/ticks', mws.requirePlatformAdmin, asyncHandler(c.listTicks))
