 ...
 *
 * trigger='pet' 已在 @shared/enums 的 POINTS_TRIGGER_DIRECTION 中标记
 * direction=-1（扣分）。本文件只做语义包装：
 ...
 *
 * 2026-06-21 pet-system-v2-ext：consumableKey 走 DB-driven 的 PetConsumable.key
 *
 * @param {Object} opts
 * @param {String} opts.orgId
 * @param {String} opts.studentId
 * @param {String} opts.petAccountId
 * @param {String} opts.consumableKey - PetConsumable.key
 ...
 */
async function chargeForFeed({ orgId, studentId, petAccountId, consumableKey, cost, expGain, hungerGain, operatorId }) {
